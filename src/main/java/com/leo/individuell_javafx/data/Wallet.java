package com.leo.individuell_javafx.data;
...
public class Wallet {
  ...
  // Very convoluted
  public ObservableList<PeriodicExpensesAndIncome> getIncomeOrExpenses(Period period, boolean positive) {
    ObservableList<PeriodicExpensesAndIncome> result = FXCollections.observableArrayList();
